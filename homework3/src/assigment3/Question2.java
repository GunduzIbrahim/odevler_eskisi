...
public class Question2 {
	...
	public static void main(String[] args) {
		...
		String mesaj = girilenGun.equals("cumartesi") || girilenGun.equals("pazar") ? (girilenGun.equals("cumartesi") ? "Cumartesi ve hafta sonu" : "Pazar ve hafta sonu") : ("gun hafta ici");
